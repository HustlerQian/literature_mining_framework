...
nodes <- read.csv("./polnet2016/Data files/Dataset1-Media-Example-NODES.csv", header=T, as.is=T)
links <- read.csv("./polnet2016/Data files/Dataset1-Media-Example-EDGES.csv", header=T, as.is=T)
